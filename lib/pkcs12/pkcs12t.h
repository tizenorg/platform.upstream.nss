...
/* PKCS 12 Templates */
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12PFXItemTemplate_OLD[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12AuthenticatedSafeTemplate_OLD[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12BaggageTemplate_OLD[];
...
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12BaggageTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12ESPVKItemTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12PVKSupportingDataTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12PVKAdditionalTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12SafeContentsTemplate_OLD[];
...
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12PrivateKeyTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12PrivateKeyBagTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12CertAndCRLTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12CertAndCRLBagTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12X509CertCRLTemplate_OLD[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12X509CertCRLTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12SDSICertTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12SecretBagTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12SecretTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12SecretItemTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12SecretAdditionalTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SGN_DigestInfoTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PointerToPKCS12KeyBagTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PointerToPKCS12CertAndCRLBagTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PointerToPKCS12CertAndCRLBagTemplate_OLD[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PointerToPKCS12SecretBagTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PointerToPKCS12X509CertCRLTemplate_OLD[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PointerToPKCS12X509CertCRLTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PointerToPKCS12SDSICertTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12CodedSafeBagTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12CodedCertBagTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12CodedCertAndCRLBagTemplate[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12PVKSupportingDataTemplate_OLD[];
__attribute__ ((visibility ("default"))) extern const SEC_ASN1Template SEC_PKCS12ESPVKItemTemplate_OLD[];
#endif
