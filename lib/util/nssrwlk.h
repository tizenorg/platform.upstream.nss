...
**  
***********************************************************************/
__attribute__ ((visibility ("default"))) extern NSSRWLock *
...
** RETURN:      None
***********************************************************************/
__attribute__ ((visibility ("default"))) extern void NSSRWLock_Destroy(NSSRWLock *lock);
...
** RETURN:      None
***********************************************************************/
__attribute__ ((visibility ("default"))) extern void NSSRWLock_LockRead(NSSRWLock *lock);
...
** RETURN:      None
***********************************************************************/
__attribute__ ((visibility ("default"))) extern void NSSRWLock_LockWrite(NSSRWLock *lock);
...
** RETURN:      void
***********************************************************************/
__attribute__ ((visibility ("default"))) extern void NSSRWLock_UnlockRead(NSSRWLock *lock);
...
** RETURN:      void
***********************************************************************/
__attribute__ ((visibility ("default"))) extern void NSSRWLock_UnlockWrite(NSSRWLock *lock);
...
__attribute__ ((visibility ("default"))) extern PRBool NSSRWLock_HaveWriteLock(NSSRWLock *rwlock);
